...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>郵便番号から住所を選択 - サンプル - zippyzipjp</title>
        ...
        <script type="text/javascript" charset="UTF-8" src="/scripts/jquerysamplez.js"></script>
        </head>
    <body>
        <div id="body">
            <div id="header">
...
<div id="bc">
    ...
    <a href="/list/jquerysample">郵便番号 &harr; 住所</a>
        ...
        <p>ソース <a href="/scripts/jquerysamplez.js" charset="UTF-8">jquerysamplez.js</a></p>
