...
function createPrefList() {
    ...
    $.ajax ({
        url: '/zippyzipjp/list/prefs.json',
        dataType: 'json',
...
function showAddList() {
    ...
    // 住所候補リストダイアログを表示する。
    $.ajax ({
        url: '/zippyzipjp/list/' + $('#zip1').val() + $('#zip2').val() + '.json',
        dataType: 'json',
        success: function(data) {
...
function showCityList() {
    ...
    $.ajax ({
        url: '/zippyzipjp/list/' + $('#pref').val() +  '.json',
        dataType: 'json',
        success: function(data) {
...
function showAdd1List() {
    ...
    $.ajax ({
        url: '/zippyzipjp/list/' + $('#x0402').val() + '.json',
        dataType: 'json',
        success: function(data) {
...
function showAdd2List() {
    ...
    $.ajax ({
        url: '/zippyzipjp/list/' + $('#x0402').val() + '-' + toHex($('#add1').val()) + '.json',
        dataType: 'json',
        success: function(data) {
...
function showCorpList() {
    ...
    $.ajax ({
        url: '/zippyzipjp/list/' + $('#x0402').val() + 'c.json',
        dataType: 'json',
        success: function(data) {
